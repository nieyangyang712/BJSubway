...
import { asyncRouterMapUser } from 'src/syscfg/router/index.js';
  ...
  actions: {
    GenerateRoutes({ commit }, data) {
      return new Promise(resolve => {
        ...
        console.log(roles, 'roles', asyncRouterMapUser)
        ...
        //   accessedRouters = asyncRouterMapUser
        // } else {
        //   accessedRouters = filterAsyncRouter(asyncRouterMapUser, roles)
        // }
